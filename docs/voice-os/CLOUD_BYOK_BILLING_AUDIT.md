...
Preuve staging du 18 août 2026 : health 200, readiness base 200, configuration desktop auth 200, clé publique d'entitlements Ed25519 conforme 200, entitlements sans session 401 et sync sans session 401. Les 74 tests du dépôt Cloud passent. Le validateur vérifie aussi que le JWKS expose exactement la clé publique attendue et jamais la clé privée. Le parcours Google interactif doit encore être rejoué par un utilisateur dans le nouveau binaire, car il nécessite le compte et le navigateur de l'opérateur.
