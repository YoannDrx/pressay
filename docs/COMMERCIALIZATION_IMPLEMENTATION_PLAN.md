...
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| App source                 | PR #67 merged into `main` after all required checks and explicit human approval; `2.0.0-beta.3` release work is isolated on `codex/pressay-2-commercial-release`.      | Re-run the complete release suite on the beta.3 commit and attach the native macOS matrix.                                                      | in_progress   |
...
| Public DMG                 | The inner beta.2 app is notarized, but the published DMG container was rejected by Gatekeeper as unstapled. The beta.3 workflow now submits and staples the final DMG. | Run the protected beta.3 workflow, download the GitHub asset, repeat Gatekeeper validation, then publish the draft.                             | in_progress   |
