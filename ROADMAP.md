...
## État d’implémentation au 28 juillet 2026
...
| 1.2 — Modes et transformation | Schéma v2 migrable, 12 modes natifs, modes personnalisés, profils opt-in, consentement cloud interactif, sélection AX/fallback transactionnel, aperçu, replay mémoire, fixture AX et actions post-insertion codés | Matrice Tier A/B, bêta notarialisée et gates externes décrits dans `RELEASE_1_2_CHECKLIST.md` |
| 1.3 — Local/hybride | Routeurs transcription/traitement et dépôt de modèles signé/SHA-256 codés | Fournisseurs FluidAudio, whisper.cpp, SpeechAnalyzer, Foundation Models et llama.cpp, catalogue publié, interface Modèles et corpus |
...
La suite automatisée contient actuellement **54 tests Swift et 2 tests Python**. La version 1.1 ou 1.2
ne doit pas être taguée sur cette seule base.
