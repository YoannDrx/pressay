    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          style={{
            background: `linear-gradient(to right, var(--color-accent) 0%, var(--color-accent) ${progressPercent}%, color-mix(in srgb, var(--color-muted), transparent 80%) ${progressPercent}%, color-mix(in srgb, var(--color-muted), transparent 80%) 100%)`,
          }}
        />
