{
  description = "Pressay - local-first speech-to-text desktop application";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          pressay = pkgs.rustPlatform.buildRustPackage {
            pname = "pressay";
            inherit version;
            src = self;
            ...
            meta = {
              description = "Local-first speech-to-text desktop application";
              homepage = "https://press-say.app";
          ...
          default = self.packages.${system}.pressay;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.pressay.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.pressay;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.pressay.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.pressay;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Pressay development environment"
              bun install
